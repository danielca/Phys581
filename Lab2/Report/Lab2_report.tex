...
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.9\linewidth]{../Plots/LorenzPhase1.pdf}
    \caption{Time series, phase space, and DFT of the Lorenz System for R=1}
    \label{fig:Phase1}
\end{figure*}
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.9\linewidth]{../Plots/LorenzPhase3.pdf}
    \caption{Time series, phase space, and DFT of the Lorenz System for R=3}
    \label{fig:Phase3}
\end{figure*}
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.9\linewidth]{../Plots/LorenzPhase13.pdf}
    \caption{Time series, phase space, and DFT of the Lorenz System for R=13}
    \label{fig:Phase13}
\end{figure*}
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.9\linewidth]{../Plots/LorenzPhase145.pdf}
    \caption{Time series, phase space, and DFT of the Lorenz System for R=14.5}
    \label{fig:Phase145}
\end{figure*}
\begin{figure*}[htb]
    \centering
    \includegraphics[width=0.9\linewidth]{../Plots/LorenzPhase26.pdf}
