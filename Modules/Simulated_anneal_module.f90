...
MODULE Simulated_anneal_module
...
SUBROUTINE sa(n, x, fcn, max, rt, eps, ns, nt, neps, maxevl, lb, ub, c, iprint,  &
...
!        optimized. (DP(N))
!    FCN - Function to be maximized or minimized FCN(n, theta(n), h)
