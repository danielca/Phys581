program Lab1_main
    ...
    real(8), dimension(1000000) :: tau, mu, phi
    real(8), dimension(100) :: tau_bins, mu_bins, phi_bins
    integer, dimension(100) :: tau_hist, mu_hist, phi_hist
    integer :: tau_id, mu_id, phi_id
    integer :: i
